...
def mp_worker(name, wait_time, status_no=0):
    """ Example worker function. This function will print out the name of the worker and wait 'wait_time
        seconds. 

    """

    print("Process ", name, "Waiting", wait_time, "s, status:", status_no)
...
if __name__ == '__main__':
    ...
    results = DomainParallelizer(data, mp_worker, cpu_cores, kwarg_dict={'status_no': 10})
